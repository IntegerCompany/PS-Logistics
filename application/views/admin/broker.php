			...
			<div class="modal-body row body-modal valid-form">
				<form>
					...
					<div class="col-md-6 form-group">
						...
						<input name="name" class="form-control" data-valid placeholder="Name Brokers Company" type="text"
							    autocomplete="off">
					</div>
					<div class="col-md-6 form-group">
					...
					<div class="col-md-6 form-group">
						...
						<textarea class="form-control" rows="1" name="notes"  data-valid placeholder="Notes..."></textarea>
					</div>
