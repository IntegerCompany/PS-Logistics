      		...
      		<div class="modal-body">
        		<form id="add-form" class="form-horizontal col-sm-12">
          			<div class="form-group">
          				...
          				<input name="user-name" class="form-control required" placeholder="First Name" type="text" required autocomplete="off">
   					</div>
          			<div class="form-group">
          				<label>Last Name</label>
          				<input name="user-last-name" class="form-control required" placeholder="Last Name"  type="text" required autocomplete="off">			
          			</div>
	  			    <div class="form-group">
          			...
          			<div class="form-group">
          				<label>Address</label>
          				<textarea class="form-control" placeholder="Your address" data-placement="top" data-trigger="manual"></textarea>
          			</div>
					<div class="form-group">
          				<label>Zip code</label>
          				<input name="user-zip-code" class="form-control" placeholder="Zip code" maxlength="5">	
          			</div>
          			<div class="form-group">
          				<label>Phone</label>
          				<input name="user-phone" class="form-control phone" placeholder="999-999-9999" type="text"  maxlength="12">	
          			</div>
          			<div class="form-group">
          				<label>SSN</label>
          				<input name="user-ssn" class="form-control " type="text"  placeholder="999-99-9999"  maxlength="11" type="text" />
          			</div>
          			<div class="form-group">
          				<label>E-Mail</label>
          				<input  name="user-email" class="form-control email" placeholder="email@you.com" type="text" required autocomplete="off">			
          			</div>
          			<!--only 8 digits -->
					<div class="form-group">
          				<label>Driver Licence</label>
          				<input class="form-control required" placeholder="Your Driver Licence " data-placement="top" data-trigger="manual" data-content="Must be at least 3 characters long, and must only contain letters." type="text" maxlength="8">
          			</div>
       				<div class="form-group">
          				<label>Class</label>
					...
					<div class="form-group">
          				...
          				<input type="checkbox" name="ccard"> 1
          				<input type="checkbox" name="ccard"> 2
          				<input type="checkbox" name="ccard"> 3
          				<input type="checkbox" name="ccard"> 4
          			</div>
					<div class="form-group">
					...
					<div class="form-group">
          				...
          				<input name="user-emergency-name" class="form-control required" placeholder="Emergency Contact name" data-placement="top" data-trigger="manual" data-content="Must be at least 3 characters long, and must only contain letters." type="text">
          			</div>
          			<div class="form-group">
          				<label>Emergency Contact phone</label>
          				<input name="user-emergency-phone" class="form-control phone" placeholder="999-999-9999" maxlength="12" type="text">
    				</div>
          			<div class="form-group">
...
<div class="col-md-10" id="content">
	<div class="row">
		<div class="container-fluid">
			...
			<div class="home">Home>Stuff</div>

			


<!-- <table class="table-bordered"> -->
 <table id="add-customer" class="table " >
   <tr>
